...
**`https://metrics-odr.github.io/dash-thata-opn/`**
...
- Repository access: **Only select repositories → `dash-thata-opn`**
...
### URL
```
https://api.github.com/repos/metrics-odr/dash-thata-opn/actions/workflows/deploy.yml/dispatches
```
...
```
```
Authorization: Bearer <<PREENCHER: TOKEN fine-grained do GitHub — nunca comitar>>  <!-- SUBSTITUA pelo token gerado no Passo 2; nunca comite o valor real -->
```
```
